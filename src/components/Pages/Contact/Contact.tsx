...
export default function Contact() {
    return (
        <div className=" items-center justify-center min-h-screen bg-[#F8EDE3] text-[#8D493A] p-4">
            <div>
                <h1 className="text-5xl text-[#8D493A] font-bold text-center mb-8 mt-20 pt-10">Let's Bring Your <br /> Vision to Life</h1>
            </div>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-5xl">
                    ...
                    <div className="w-full md:w-1/2 p-4">
                        <div className="bg-[#F7E9DC] rounded-lg overflow-hidden">
                            <Image
                                src={contact.src} // Replace with your chair image path
                                alt="Chair Design"
                                width={500}
                                height={500}
                    ...
                    {/* Right Section - Form */}
                    <div className="w-full md:w-1/2 p-4">
                        <div className="bg-[#F7E9DC] p-6 rounded-lg h-[600] ">
